...
# 
# If you do any of the following, you will get something like, `Grader Error: Grader feedback not found` (or similarly unexpected) error upon submitting your assignment. Before asking for help/debugging the errors in your assignment, check for these first. If this is the case, and you don't remember the changes you have made, you can get a fresh copy of the assignment by following these [instructions](https://www.coursera.org/learn/convolutional-neural-networks/supplement/b6TbJ/optional-downloading-your-notebook-downloading-your-workspace-and-refreshing).
...
def unet_model(input_size=(96, 128, 3), n_filters=32, n_classes=23):
    ...
    ### START CODE HERE
    cblock1 = conv_block(inputs, n_filters,dropout_prob=0,max_pooling = True)
    # Chain the first element of the output of each block to be the input of the next conv_block. 
    # Double the number of filters at each new step
    cblock2 = conv_block(cblock1[0], n_filters*2,dropout_prob=0,max_pooling = True)

    cblock3 = conv_block(cblock2[0], n_filters*2*2,dropout_prob=0,max_pooling = True)
    cblock4 = conv_block(cblock3[0], n_filters*2*2*2, dropout_prob=0.3,max_pooling = True) # Include a dropout_prob of 0.3 for this layer
    # Include a dropout_prob of 0.3 for this layer, and avoid the max_pooling layer
    cblock5 = conv_block(cblock4[0], n_filters*2*2*2*2, dropout_prob=0.3, max_pooling=False) 
    ### END CODE HERE
