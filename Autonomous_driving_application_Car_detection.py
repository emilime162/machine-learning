...
def yolo_filter_boxes(boxes, box_confidence, box_class_probs, threshold = .6):
    ...
    Arguments:
        boxes -- tensor of shape (19, 19, 5, 4) -> (grid_height, grid_width, num_anchors, 4) 
        4: The four coordinates (b_x, b_y, b_h, b_w)
    ...
    box_classes = tf.math.argmax(box_scores, axis = -1) # find index
    box_class_scores = tf.reduce_max(box_scores, axis=-1) # find actual score
